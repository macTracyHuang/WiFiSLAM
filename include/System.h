...
public:
    ...
    Sophus::SE3f TrackRGBD_Wifi(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp, Fingerprint* fingerprint, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
