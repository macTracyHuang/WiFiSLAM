 ...
 * @param[in] nNumCandidates 期望的候选数目,即回环和候选分别应该有多少个
 */
void KeyFrameDatabase::DetectNBestCandidatesWithWiFi(KeyFrame *pKF, vector<KeyFrame *> &vpLoopCand, vector<KeyFrame *> &vpMergeCand, int nNumCandidates)
{
    ...
    // Search all keyframes that share a word with current frame
    {
        ...
        // Filter candicates by wifi pose first add by tm
